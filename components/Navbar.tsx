    ...
    <header className={navbarShell}>
      <div className="mx-auto flex max-w-7xl items-center justify-between px-5 py-2.5 sm:px-6">
        ...
        <details className="relative md:hidden">
          ...
          <div className="absolute right-0 mt-2 w-56 rounded-2xl border border-slate-200/70 bg-white/95 p-2 shadow-[0_12px_40px_rgba(15,23,42,0.10)] backdrop-blur-xl">
            {navLinks.map((link) => (
              <Link
                key={link.href}
                href={link.href}
